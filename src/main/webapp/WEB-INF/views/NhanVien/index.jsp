                    ...
                    <div class="card recent-sales overflow-auto">
                        <div class="card-body">
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                <c:forEach items="${listNV}" var="mau" varStatus="tt">
                                    <tr>
                                        ...
                                        <td><p style="color:${mau.chucVu.id==1?"chartreuse":"red"}">${mau.chucVu.id ==1  ? "Quản lý" : "Nhân viên"}</p></td>
                                        <td><p style="color:${mau.trangThai==0?"chartreuse":"red"}">${mau.trangThai ==0  ? "Đang làm" : "Đã nghỉ"}</p></td>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content pt-2" id="myTabContent">
                        <div class="${active == null?"tab-pane fade show active":"tab-pane fade"}" id="home" role="tabpanel"
                            ...
                            <div>
                                Địa chỉ :
                                <input type="text" class="form-control" id="diaChiUpdate">
                            </div>
                            ...
                            <div id="trangThaiUpdate">
                                ...
                                <div style="display: flex">
                                    <div style="margin-right: 30px">
                                <input type="radio" name="trangThaiUpdate" checked value="0">Đang làm
                                    </div>
                                    <div>
                                <input type="radio" name="trangThaiUpdate" value="1">Nghỉ việc
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="chucVuUpdate">
                                ...
                                <div style="display: flex">
                                    <div style="margin-right: 30px">
                                <input type="radio" name="chucVuUpdate" checked value="1">Quản lý
                                    </div>
                                    <div>
                                <input type="radio" name="chucVuUpdate" value="2">Nhân viên
                                    </div>
                                </div>
                        ...
                        <div class="${active == null?"tab-pane fade":"tab-pane fade show active"}" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div id="trangThaiAdd">
                                ...
                                <div style="display: flex">
                                    <div style="margin-right: 30px">
                                <input type="radio" name="trangThaiAdd" checked value="0">Đang làm
                                    </div>
                                    <div>
                                <input type="radio" name="trangThaiAdd" value="1">Nghỉ việc
                                </div>
                                </div>
                            </div>
                            ...
                            <div id="chucVuAdd">
                                ...
                                <div style="display: flex">
                                    <div style="margin-right: 30px">
                                <input type="radio" name="chucVuAdd" checked value="1">Quản lý
                                    </div>
                                    <div>
                                <input type="radio" name="chucVuAdd" value="2">Nhân viên
                                    </div>
                                </div>
                            </div>
...
<script>
    function detail(id){
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response.chucVu.id == 1) {
                    $('input[name="chucVuUpdate"][value="1"]').prop('checked', true);
                } else if (response.chucVu.id == 2) {
                    $('input[name="chucVuUpdate"][value="2"]').prop('checked', true);
                }
    ...
    function update() {
        ...
        var chucVuValue = $('input[name="chucVuUpdate"]:checked', '#chucVuUpdate').val();
        ...
        var diaChi = document.getElementById('diaChiUpdate').value;
        ...
        if (id.trim() === '') {
            ...
            if (hoTen.trim() === '' || ngaySinh.trim() === '' || sdt == null|| diaChi == null|| email == null|| taiKhoan == null|| matKhau == null) {
                ...
                if (cf == true) {
                    ...
                    formData.append('chucVu',chucVuValue);
    ...
    function add() {
        ...
        var chucVuValue = $('input[name="chucVuAdd"]:checked', '#chucVuAdd').val();
        ...
        var diaChi = document.getElementById('diaChiAdd').value;
