    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><h1>Hủy hóa đơn</h1></li>
                ...
                <div class="row" style="margin-top: 50px;">
                    <div class="product-details">
                        <div class="col-md-7">
                            <form action="/bill/delete/${id}" method="post">
                                <div class="product-info">
                                    <label for="exampleFormControlTextarea1" class="form-label">Nhập nội dung hủy</label>
