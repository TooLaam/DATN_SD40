                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <c:forEach items="${listGG}" var="mau" varStatus="tt">
                                    <tr>
                                        ...
                                        <td>${mau.ngaySua}</td>
                                        <td>
                                            <a href="/giamgia/detail/${mau.id}" class="btn btn-success">Chi tiết</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content pt-2" id="myTabContent">
                        <div class="${active == null?"tab-pane fade show active":"tab-pane fade"}" id="home" role="tabpanel"
                            ...
                            <form method="post" action="/giamgia/update" enctype="multipart/form-data">

                                <div>
                                    ID :
                                    <input type="text" class="form-control" readonly name="id" value="${gg.id}">
                                </div>

                                <div>
                                    Tên :
                                    <input type="text" class="form-control" required name="ten" value="${gg.ten}">
                                </div>
                                ...
                                <div>
                                    Ngày tạo :
                                    <input class="form-control" readonly name="ngayTao" value="${gg.ngayTao}">
                                </div>

                                <div>
                                    Ngày sửa gần nhất :
                                    <input class="form-control" readonly name="" value="${gg.ngaySua}">
                                </div>
                                <div>
                                    Mức giảm :
                                    <input type="number" required class="form-control" name="mucGiam" value="${gg.mucGiam}">
                                </div>
                        ...
                        <div class="${active == null?"tab-pane fade":"tab-pane fade show active"}" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <form method="post" action="/giamgia/add" enctype="multipart/form-data">
                                <div>
                                    Tên :
                                ...
                                <div>
                                    Mức giảm :
                                    <input type="number" required class="form-control" name="mucGiam">
                                </div>
                                <div>
                                    Trạng thái :<br>
