                                ...
                                <div class="product-info">
                                    <div class="row">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="date" class="form-control" value="${nhanVien.ngaySinh}" name="ngaySinh" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="">
                                        ...
                                        <div class="">
                                            ...
                                            <input type="email" class="form-control" value="${nhanVien.email}"  name="email" readonly>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="">
