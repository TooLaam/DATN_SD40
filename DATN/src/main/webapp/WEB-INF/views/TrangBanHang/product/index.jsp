...
<div class="container">
    <div class="content">
        <span class="text-content">Các loại giầy trong cửa hàng</span>
    ...
    <div class="row">
        ...
        <div class="col-9">
            <div class="row">
                <c:forEach items="${listGiay}" var="sp">
                    <div class="col-md-3 col-6">
                        <div class="thumnail">
                            <a href="/product_detail/chiTiet/${sp.id}">
                                <img src="/assets/img/product/a46.png">
                                <div class="caption">
                                    <p>${sp.ma}</p>
                                    <span class="price">$${sp.ten}</span>
                                    <span class="sold">${sp.moTa}</span>
                                </div>
                            </a>
                        </div>
                    </div>
